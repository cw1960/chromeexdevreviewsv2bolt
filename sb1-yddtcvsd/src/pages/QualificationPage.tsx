...
export function QualificationPage() {
  ...
  const guidelines = [
    ...
    {
      icon: Clock,
      title: 'Use Extensions for 24+ Hours',
      description: 'Install and actively use extensions for at least 24 hours before reviewing to provide meaningful feedback.'
    },
    {
      icon: BookOpen,
